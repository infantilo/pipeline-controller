...
const playerArg = argv[argv.indexOf('--player') + 1] || 'player1';
const pstrArg   = argv[argv.indexOf('--pstr')  + 1] || null; // null = alle testen
...
const AudioGroupConfig = require('./AudioGroupConfig');
